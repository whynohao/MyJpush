...
namespace cn.jpush.server
{
    public class JPushApiExample
    {
        ...
        //内容
        public static string ALERT = "消息通知：请查收红包!";
        ...
        #region 极光 app_key和master_secret
        public static string app_key = "addd228db22a21aa1f5f8c49";
        public static string master_secret = "7bbc4a029d0c2edeaaf858f2";
        #endregion
